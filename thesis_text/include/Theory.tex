...
Using this generalized product type with \texttt{Bool} as the index type is equivalent to having a normal product - which makes sense, since it means taking a product of two polynomials. This is proved in \texttt{Various.agda}.
