...
The first part, theory, formalizes the category \textbf{Poly} itself and many of its categorical constructs, including the initial and terminal objects, product, coproduct, equalizer, composition and parallel product. % , among others. % as two monoids, and many various proofs around the category.
Then \textbf{Chart} is formalized, together with its own categorical constructs.
Finally, \textbf{Poly} and \textbf{Chart} morphisms are combined via commuting squares.   %, aoeuaoeu
