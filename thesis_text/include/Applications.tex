...
However, it is explain how dynamical systems are modeled by lenses in extreme details.
...
\end{tikzcd}\]
    ...
    \caption{A special kind of commuting square. The identity chart turns this into a commuting triangle. The chart at the top is defined as the function reducing the states between the systems. The laws fulfilled if this diagram commutes encodes what it means for a system to simulate another.}
